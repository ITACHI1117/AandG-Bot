...
def verify_policy(certi_No):
    ...
    driver.find_element(by="xpath", value='//div[@class="menu-list"]/ul/ul/div[6]/div/li/a').click()
    time.sleep(0.5)

    # Find the Verify Policy button and click on it.
    driver.find_element(by="xpath", value='//div[@class="menu-list"]/ul/ul/div[6]/div[2]/ul/li[4]').click()
    time.sleep(0.5)

    # Find the SearchBy (select attribute) option and click on it.
    driver.find_element(by="xpath", value='//div[@class="col-md-offset-3 col-md-4 center-block panel-primary panel-heading"]/select').click()
    time.sleep(0.5)

    # Find the fetch by policy button and click on it.
    driver.find_element(by="xpath", value='//div[@class="col-md-offset-3 col-md-4 center-block panel-primary panel-heading"]/select/option[3]').click()
    time.sleep(0.5)
    ...
    certi_number = driver.find_element(by="xpath", value='//div[@class="col-md-offset-3 col-md-4 center-block panel-primary panel-heading"]/input')
    ...
    Header = driver.find_element(by="xpath",value='//div[@class="col-md-offset-3 col-md-10 center-block panel-primary panel-heading"]/div').text
    print(Header)

    time.sleep(0.5)

    # Finds the Texte on the table
    titles = driver.find_elements(by="xpath",value='//div[@class="col-md-offset-3 col-md-10 center-block panel-primary panel-heading"]/div[2]/table/tbody/tr/th')
    subtitles = driver.find_elements(by="xpath",value='//div[@class="col-md-offset-3 col-md-10 center-block panel-primary panel-heading"]/div[2]/table/tbody/tr[2]/td')
